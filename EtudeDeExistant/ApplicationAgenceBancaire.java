...
public class ApplicationAgenceBancaire {
	...
	public static void afficherMenuOperationCompte(AgenceBancaire ag) {
		System.out.println("Menu de " + ag.getNomAgence() + " (" + ag.getLocAgence() + ")");
	...
	public static void afficherMenuGestionCompte(AgenceBancaire ag) {
		System.out.println("Menu de " + ag.getNomAgence() + " (" + ag.getLocAgence() + ")");
		...
		while (continuer) {
			...
			switch (choix) {
				...
				case "2" :
					...
					break;
				case "3" :
					afficherMenuOperationCompte(monAg);
					choixOperation = lect.next();
					choixOperation = choixOperation.toLowerCase();
					...
					break;		
				case "4" :
					afficherMenuGestionCompte(monAg);
					choixGestion = lect.next();
					choixGestion = choixGestion.toLowerCase();
					switch(choixGestion) {
						case "0" :
							System.out.println("ByeBye");
							ApplicationAgenceBancaire.tempo();
